...
public class Converter_1_1Test {
  ...
  public void converts1() throws Exception {
    ...
    assertEquals(4.5, new Converter_1_1().apply(CONVERSION_RATE).apply(3.0),0.0001);
  }

  @Test
  public void converts() throws Exception {
    Function<Double, Double> converterFunction = new Converter_1_1().apply(CONVERSION_RATE);
